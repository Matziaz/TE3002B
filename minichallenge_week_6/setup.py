...
package_name = 'minichallenge_week_6'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'odometry_node = minichallenge_week_6.odometry_node:main',
            'color_detector_node = minichallenge_week_6.color_detector_node:main',
            'traffic_light_controller = minichallenge_week_6.traffic_light_controller:main',
            'go_to_goal_node = minichallenge_week_6.go_to_goal_node:main',
            'line_follower_node = minichallenge_week_6.line_follower_node:main',
        ],
    },
)
